	...
	<table>
		...
		<tr>
			...
			<c:forEach items="${mens}" var="mesnproducts">
				...
				<td>
					<div class="car">
						<img src="${mesnproducts.image}" alt="show image"> <br>
						${mesnproducts.productName} ${mesnproducts.description} <strong>Starts
							from RS:${mesnproducts.standardCost}</strong> <br>
					</div>
